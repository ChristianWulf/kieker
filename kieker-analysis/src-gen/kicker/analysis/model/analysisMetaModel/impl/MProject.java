/**
 */
package kicker.analysis.model.analysisMetaModel.impl;
...
import kicker.analysis.model.analysisMetaModel.MIAnalysisMetaModelPackage;
import kicker.analysis.model.analysisMetaModel.MIDependency;
import kicker.analysis.model.analysisMetaModel.MIPlugin;
import kicker.analysis.model.analysisMetaModel.MIProject;
import kicker.analysis.model.analysisMetaModel.MIProperty;
import kicker.analysis.model.analysisMetaModel.MIRepository;
import kicker.analysis.model.analysisMetaModel.MIView;
 ...
 * <ul>
 *   <li>{@link kicker.analysis.model.analysisMetaModel.impl.MProject#getPlugins <em>Plugins</em>}</li>
 *   <li>{@link kicker.analysis.model.analysisMetaModel.impl.MProject#getName <em>Name</em>}</li>
 *   <li>{@link kicker.analysis.model.analysisMetaModel.impl.MProject#getRepositories <em>Repositories</em>}</li>
 *   <li>{@link kicker.analysis.model.analysisMetaModel.impl.MProject#getDependencies <em>Dependencies</em>}</li>
 *   <li>{@link kicker.analysis.model.analysisMetaModel.impl.MProject#getViews <em>Views</em>}</li>
 *   <li>{@link kicker.analysis.model.analysisMetaModel.impl.MProject#getProperties <em>Properties</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
