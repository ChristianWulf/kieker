...
package kicker.test.analysis.junit.plugin; // NOCS (outer types)
...
import kicker.test.analysis.util.plugin.filter.SimpleForwardFilterWithRepository;
import kicker.test.analysis.util.repository.SimpleRepository;
