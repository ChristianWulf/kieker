...
package kicker.test.analysis.util.plugin.filter.flow;
...
import kicker.common.record.flow.trace.operation.CallOperationEvent;
import kicker.test.common.util.record.BookstoreOperationExecutionRecordFactory;

/**
 * A starter method for this factory is implemented in kicker.test.tools.junit.traceAnalysis.util.BookstoreEventRecordFactoryStarter.
 * 
...
public final class BookstoreEventRecordFactory {
	 ...
	 * {@link kicker.common.record.flow.trace.AbstractTraceEvent#getOrderIndex()}es.
	 * 
	 ...
	 * by
	 * its {@link kicker.common.record.flow.trace.AbstractTraceEvent#getOrderIndex()}es.
	 * 
	 * @param firstTimestamp
	 *            timestamp of the earliest event, incremented by 1 for each subsequent event
	 * @param traceId
	 ...
	 * Returns the "well-known" Bookstore trace as a list of {@link CallOperationEvent}, {@link BeforeOperationEvent} and {@link AfterOperationEvent} events, ordered
	 * by
	 * its {@link kicker.common.record.flow.trace.AbstractTraceEvent#getOrderIndex()}es. In this trace, <i>CRM.getOrders</i> is assumed not to be instrumented.
	 * 
	 * @param firstTimestamp
	 *            timestamp of the earliest event, incremented by 1 for each subsequent event
	 * @param traceId
	 ...
	 * events, ordered by its {@link kicker.common.record.flow.trace.AbstractTraceEvent#getOrderIndex()}es. In this trace, <i>CRM.getOrders</i> and
	 ...
	 * events, ordered by its {@link kicker.common.record.flow.trace.AbstractTraceEvent#getOrderIndex()}es. In this trace, <i>Catalog.getBook</i> is assumed
