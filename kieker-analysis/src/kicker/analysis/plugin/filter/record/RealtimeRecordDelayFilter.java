...
package kicker.analysis.plugin.filter.record;
...
/**
 * Forwards incoming {@link IMonitoringRecord}s with delays computed from the {@link kicker.common.record.IMonitoringRecord#getLoggingTimestamp()} value
