...
import kicker.analysis.model.analysisMetaModel.impl.MAnalysisMetaModelFactory;
import kicker.analysis.model.analysisMetaModel.impl.MAnalysisMetaModelPackage;
import kicker.analysis.plugin.AbstractPlugin;
import kicker.analysis.plugin.IPlugin;
import kicker.analysis.plugin.IPlugin.PluginInputPortReference;
...
/**
 * This is a helper class for the {@link kicker.analysis.AnalysisController}, which manages the handling of the meta model instances.
 * 
