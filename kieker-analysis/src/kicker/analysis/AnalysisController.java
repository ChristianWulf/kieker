...
import kicker.analysis.model.MetaModelHandler;
import kicker.analysis.model.MetaModelHandler.PluginConnection;
import kicker.analysis.model.MetaModelHandler.RepositoryConnection;
...
import kicker.analysis.plugin.reader.IReaderPlugin;
 ...
 * @since 0.95a
 */
@kicker.analysis.annotation.AnalysisController(
		configuration = {
...
public final class AnalysisController implements IAnalysisController { // NOPMD (really long class)
	...
	private final Configuration getDefaultConfiguration() {
		...
		final kicker.analysis.annotation.AnalysisController annotation = this.getClass().getAnnotation(kicker.analysis.annotation.AnalysisController.class);
		if (null != annotation) {
