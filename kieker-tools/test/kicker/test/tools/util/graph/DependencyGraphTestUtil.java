...
package kicker.test.tools.util.graph;
...
import kicker.tools.traceAnalysis.filter.visualization.dependencyGraph.AbstractDependencyGraph;
...
public final class DependencyGraphTestUtil {
	 ...
	 * @return A map which associates the node's identifier (see {@link kicker.tools.traceAnalysis.filter.visualization.graph.AbstractGraphElement#getIdentifier()})
