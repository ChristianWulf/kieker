...
package kicker.test.tools.junit.traceAnalysis.filter.visualization.traceColoring;
...
import kicker.test.tools.util.graph.DependencyGraphTestUtil;
import kicker.test.tools.util.graph.GraphReceiverPlugin;
import kicker.test.tools.util.graph.GraphTestSetup;
...
import kicker.tools.traceAnalysis.filter.visualization.dependencyGraph.DependencyGraphNode;
...
import kicker.tools.traceAnalysis.repository.TraceColorRepository.TraceColorRepositoryData;
