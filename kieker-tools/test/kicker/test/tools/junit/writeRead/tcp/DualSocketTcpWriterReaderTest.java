...
import kicker.monitoring.writer.tcp.DualSocketTcpWriter;
...
import kicker.analysis.plugin.reader.tcp.DualSocketTcpReader;
 ...
 * @since 1.5
 */
public class DualSocketTcpWriterReaderTest extends AbstractWriterReaderTest { // NOPMD NOCS (TestClassWithoutTestCases)
