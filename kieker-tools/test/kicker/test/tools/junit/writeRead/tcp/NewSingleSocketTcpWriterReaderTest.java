...
import kicker.monitoring.writer.tcp.SingleSocketTcpWriter;
...
import kicker.analysis.plugin.reader.tcp.SingleSocketTcpReader;
...
public class NewSingleSocketTcpWriterReaderTest extends AbstractWriterReaderTest { // NOPMD NOCS (TestClassWithoutTestCases)
	...
	protected MonitoringController createController(final int numRecordsWritten) throws IllegalStateException, AnalysisConfigurationException,
		...
		readerConfig.setProperty(SingleSocketTcpReader.CONFIG_PROPERTY_NAME_PORT, NewSingleSocketTcpWriterReaderTest.PORT1);
