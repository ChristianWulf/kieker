...
package kicker.tools.traceAnalysis.filter.visualization.graph;
 ...
 * be retained and corresponds to the kind {@link kicker.tools.traceAnalysis.filter.visualization.graph.OriginRetentionPolicyKind#SPECIFIC}. Two specific
