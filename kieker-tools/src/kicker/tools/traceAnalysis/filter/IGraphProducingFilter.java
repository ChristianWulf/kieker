...
package kicker.tools.traceAnalysis.filter;
...
public interface IGraphProducingFilter<G extends AbstractGraph<?, ?, ?>> extends IGraphOutputtingFilter<G> {
	 ...
	 * (see {@link kicker.tools.traceAnalysis.filter.visualization.graph.IOriginRetentionPolicy#isCompatibleWith(IOriginRetentionPolicy)}).
	 * 
	 * @param policy
