...
package kicker.tools.traceAnalysis.systemModel;
...
public class ExecutionTrace extends AbstractTrace {
	 ...
	 * by the {@link kicker.tools.traceAnalysis.systemModel.ExecutionTrace#add(Execution)} method. Consider to create a copy
