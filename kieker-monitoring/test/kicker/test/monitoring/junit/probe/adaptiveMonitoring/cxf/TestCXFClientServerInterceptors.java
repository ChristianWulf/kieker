...
package kicker.test.monitoring.junit.probe.adaptiveMonitoring.cxf;
...
import kicker.monitoring.probe.cxf.OperationExecutionSOAPRequestInInterceptor;
import kicker.monitoring.probe.cxf.OperationExecutionSOAPRequestOutInterceptor;
import kicker.monitoring.probe.cxf.OperationExecutionSOAPResponseInInterceptor;
import kicker.monitoring.probe.cxf.OperationExecutionSOAPResponseOutInterceptor;
import kicker.monitoring.probe.cxf.SOAPTraceRegistry;
import kicker.test.common.junit.AbstractKiekerTest;
import kicker.test.monitoring.junit.probe.cxf.executions.bookstore.BookstoreImpl;
import kicker.test.monitoring.junit.probe.cxf.executions.bookstore.IBookstore;
