...
import kicker.common.record.system.LoadAverageRecord;
...
public final class LoadAverageSampler extends AbstractSigarSampler {
	 ...
	 * should use the factory method {@link kicker.monitoring.sampler.sigar.SigarSamplerFactory#createSensorLoadAverage()} to acquire an
