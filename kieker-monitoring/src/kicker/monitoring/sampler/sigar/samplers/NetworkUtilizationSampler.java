...
import kicker.common.record.system.NetworkUtilizationRecord;
...
public final class NetworkUtilizationSampler extends AbstractSigarSampler {
	 ...
	 * should use the factory method {@link kicker.monitoring.sampler.sigar.SigarSamplerFactory#createSensorNetworkUtilization()} to acquire an
