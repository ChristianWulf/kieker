...
import kicker.common.record.system.ResourceUtilizationRecord;
...
public class CPUsCombinedPercSampler extends AbstractSigarSampler {
	 ...
	 * should use the factory method {@link kicker.monitoring.sampler.sigar.SigarSamplerFactory#createSensorCPUsCombinedPerc()} to acquire an
