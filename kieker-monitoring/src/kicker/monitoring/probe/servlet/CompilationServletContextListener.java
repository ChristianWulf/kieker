...
package kicker.monitoring.probe.servlet;

import kicker.monitoring.core.sampler.ISampler;
import kicker.monitoring.sampler.mxbean.CompilationSampler;
 ...
 * @since 1.10
 */
public class CompilationServletContextListener extends AbstractRegularSamplingServletContextListener {

	/** Prefix for parameters used in the web.xml file. */
	// NOTE that this declaration must be BEFORE the following public constants!
	private static final String CONTEXT_PARAM_NAME_PREFIX = CompilationServletContextListener.class.getSimpleName();
	...
	protected ISampler[] createSamplers() {
		return new ISampler[] { new CompilationSampler() };
	}
