...
import kicker.monitoring.sampler.mxbean.ClassLoadingSampler;
...
public class ClassLoadingServletContextListener extends AbstractRegularSamplingServletContextListener {
	...
	private static final String CONTEXT_PARAM_NAME_PREFIX = ClassLoadingServletContextListener.class.getSimpleName();
	...
	protected ISampler[] createSamplers() {
		return new ISampler[] { new ClassLoadingSampler() };
	}
}
