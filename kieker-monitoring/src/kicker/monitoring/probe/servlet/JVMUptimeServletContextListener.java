...
import kicker.monitoring.sampler.mxbean.UptimeSampler;
...
public class JVMUptimeServletContextListener extends AbstractRegularSamplingServletContextListener {
	...
	private static final String CONTEXT_PARAM_NAME_PREFIX = JVMUptimeServletContextListener.class.getSimpleName();
	 ...
	 * Empty constructor.
	 */
	public JVMUptimeServletContextListener() {
		// nothing to do
	}
	...
	protected ISampler[] createSamplers() {
		return new ISampler[] { new UptimeSampler() };
	}
