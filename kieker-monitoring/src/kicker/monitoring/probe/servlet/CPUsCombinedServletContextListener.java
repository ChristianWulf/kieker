 ...
 * @since 1.3
 */
public class CPUsCombinedServletContextListener extends AbstractRegularSamplingServletContextListener {
	...
	protected ISampler[] createSamplers() {
		...
		return new ISampler[] { sigarFactory.createSensorCPUsCombinedPerc() };
	}
