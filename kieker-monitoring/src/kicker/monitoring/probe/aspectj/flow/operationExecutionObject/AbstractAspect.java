...
package kicker.monitoring.probe.aspectj.flow.operationExecutionObject;
...
public abstract class AbstractAspect extends AbstractAspectJProbe {
	...
	public Object operation(final Object thisObject, final ProceedingJoinPoint thisJoinPoint) throws Throwable { // NOCS (Throwable)
		...
		CTRLINST.newMonitoringRecord(new BeforeOperationObjectEvent(TIME.getTime(), traceId, trace.getNextOrderId(), operationSignature, clazz, objectId));
