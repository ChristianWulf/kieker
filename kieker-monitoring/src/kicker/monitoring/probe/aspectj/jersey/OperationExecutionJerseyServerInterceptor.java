...
package kicker.monitoring.probe.aspectj.jersey;
 ...
 */
@Aspect
@DeclarePrecedence("kicker.monitoring.probe.aspectj.jersey.*,kicker.monitoring.probe.aspectj.operationExecution.*")
