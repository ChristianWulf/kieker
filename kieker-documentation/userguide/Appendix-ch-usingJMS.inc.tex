...
The file \file{src-resources/META-INF/kicker.\-monitoring.\-pro\-perties-activeMQ} %
...
\lstinputlisting[firstline=12,lastline=12,caption=Excerpt from \file{kicker.monitoring.properties-activemq} configuring the provider URL of the JMS writer via ActiveMQ]{\JMSBookstoreApplicationDir/src-resources/META-INF/kicker.monitoring.properties-activemq}

\setPropertiesListing
\lstinputlisting[firstline=21,lastline=21,caption=Excerpt from \file{kicker.monitoring.properties-activemq} configuring the context factory of the JMS writer via ActiveMQ]{\JMSBookstoreApplicationDir/src-resources/META-INF/kicker.monitoring.properties-activemq}
...
The file \file{src-resources/META-INF/kicker.\-monitoring.\-pro\-perties-hornetq} %
...
\setPropertiesListing
\lstinputlisting[firstline=12,lastline=12,caption=Excerpt from \file{kicker.monitoring.properties-hornetq} configuring the provider URL of the JMS writer via HornetQ]{\JMSBookstoreApplicationDir/src-resources/META-INF/kicker.monitoring.properties-hornetq}

\setPropertiesListing
\lstinputlisting[firstline=21,lastline=21,caption=Excerpt from \file{kicker.monitoring.properties-hornetq} configuring the context factory of the JMS writer via HornetQ]{\JMSBookstoreApplicationDir/src-resources/META-INF/kicker.monitoring.properties-hornetq}
...
The file \file{src-resources/META-INF/kicker.monitoring.\-pro\-perties-openjms} %
is already configured to use the \class{AsyncJMSWriter} via OpenJMS. The important properties are %
the definition of the provider URL and the context factory:

\setPropertiesListing
\lstinputlisting[firstline=12,lastline=12,caption=Excerpt from \file{kicker.monitoring.properties-openjms} configuring the provider URL of the JMS writer via OpenJMS]{\JMSBookstoreApplicationDir/src-resources/META-INF/kicker.monitoring.properties-openjms}

\setPropertiesListing
\lstinputlisting[firstline=21,lastline=21,caption=Excerpt from \file{kicker.monitoring.properties-openjms} configuring the context factory of the JMS writer via OpenJMS]{\JMSBookstoreApplicationDir/src-resources/META-INF/kicker.monitoring.properties-openjms}
