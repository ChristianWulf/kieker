...
\newcommand{\version}{1.13-SNAPSHOT} % will be set automatically by ant 'release' target 

% The single parts of Kieker and some files.
\newcommand{\KiekerMonitoringPart}{\textsf{kicker.\-Monitoring}}
\newcommand{\KiekerAnalysisPart}{\textsf{kicker.\-Analysis}}
\newcommand{\KiekerTraceAnalysis}{\textsf{kicker.Trace\-Analysis}}
% \newcommand{\analysisJar}{kieker-analysis-\version.jar}
\newcommand{\mainJar}{kieker-1.13-SNAPSHOT.jar} % will be set automatically by ant 'release' target
\newcommand{\mainJarEMF}{kieker-1.13-SNAPSHOT-emf.jar} % will be set automatically by ant 'release' target
\newcommand{\mainJarWeaver}{kieker-1.13-SNAPSHOT-aspectj.jar} % will be set automatically by ant 'release' target
...
\newcommand{\monitoringPropertiesFile}{kicker.\-monitoring.\-pro\-per\-ties}
\newcommand{\analysisPropertiesFile}{kicker.analysis.properties}
...
\newcommand{\kiekerMonitoringProperties}{kicker.monitoring.pro\-perties}
\newcommand{\kiekerExampleMonitoringProperties}{kicker.monitoring.ex\-am\-ple.pro\-perties}
...
% The complete url where to find kicker.
