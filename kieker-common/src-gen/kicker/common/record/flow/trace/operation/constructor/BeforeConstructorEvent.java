...
public class BeforeConstructorEvent extends BeforeOperationEvent implements IConstructorRecord {
	 ...
	 */
	public BeforeConstructorEvent(final Object[] values) { // NOPMD (direct store of values)
		super(values, TYPES);
	}
	 ...
	 */
	protected BeforeConstructorEvent(final Object[] values, final Class<?>[] valueTypes) { // NOPMD (values stored directly)
	 ...
	 */
	public BeforeConstructorEvent(final IValueDeserializer deserializer) throws BufferUnderflowException {
		super(deserializer);
	}
