...
import kicker.common.record.io.DefaultValueDeserializer;
import kicker.common.record.io.DefaultValueSerializer;
import kicker.common.util.registry.IRegistry;
import kicker.common.util.registry.Registry;
import kicker.test.common.junit.AbstractKiekerTest;
import kicker.test.common.junit.record.UtilityClass;
...
public class TestBeforeOperationEvent extends AbstractKiekerTest {
	 ...
	 * Default constructor.
	 */
	public TestBeforeOperationEvent() {
		// empty default constructor
	}

	/**
	 * Tests the constructor and toArray(..) methods of {@link BeforeOperationEvent}.
	 *
	...
	public void testSerializeDeserializeEquals() {
		...
		final BeforeOperationEvent event1 = new BeforeOperationEvent(TSTAMP, TRACE_ID, ORDER_INDEX, FQ_OPERATION_SIGNATURE, FQ_CLASSNAME);
		...
		final BeforeOperationEvent event2 = new BeforeOperationEvent(event1Array);
	...
	/**
	 * Tests the constructor and writeBytes(..) methods of {@link BeforeOperationEvent}.
	 */
	@Test
	public void testSerializeDeserializeBinaryEquals() {
		...
		final BeforeOperationEvent event2 = new BeforeOperationEvent(DefaultValueDeserializer.create(buffer, stringRegistry));
