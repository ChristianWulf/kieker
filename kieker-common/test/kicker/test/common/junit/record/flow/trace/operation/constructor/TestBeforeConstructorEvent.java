...
public class TestBeforeConstructorEvent extends AbstractKiekerTest {
	...
	/**
	 * Tests the constructor and writeBytes(..) methods of {@link BeforeConstructorEvent}.
	 */
	@Test
	public void testSerializeDeserializeBinaryEquals() {
		...
		final BeforeConstructorEvent event2 = new BeforeConstructorEvent(DefaultValueDeserializer.create(buffer, stringRegistry));
