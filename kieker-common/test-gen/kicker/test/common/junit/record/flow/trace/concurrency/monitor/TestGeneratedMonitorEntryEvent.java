 ...
 * @since 1.8
 */
public class TestGeneratedMonitorEntryEvent extends AbstractGeneratedKiekerTest {

	public TestGeneratedMonitorEntryEvent() {
		// empty default constructor
	}

	/**
	 * Tests {@link MonitorEntryEvent#TestMonitorEntryEvent(long, long, int, int)}.
	 */
	@Test
	...
	public void testEquality() {
		int i = 0;
		MonitorEntryEvent oneRecord = new MonitorEntryEvent(LONG_VALUES.get(i % LONG_VALUES.size()), LONG_VALUES.get(i % LONG_VALUES.size()), INT_VALUES.get(i % INT_VALUES.size()), INT_VALUES.get(i % INT_VALUES.size()));
		i = 0;
		MonitorEntryEvent copiedRecord = new MonitorEntryEvent(LONG_VALUES.get(i % LONG_VALUES.size()), LONG_VALUES.get(i % LONG_VALUES.size()), INT_VALUES.get(i % INT_VALUES.size()), INT_VALUES.get(i % INT_VALUES.size()));
	...
	public void testUnequality() {
		...
		MonitorEntryEvent oneRecord = new MonitorEntryEvent(LONG_VALUES.get(i % LONG_VALUES.size()), LONG_VALUES.get(i % LONG_VALUES.size()), INT_VALUES.get(i % INT_VALUES.size()), INT_VALUES.get(i % INT_VALUES.size()));
		i = 2;
		MonitorEntryEvent anotherRecord = new MonitorEntryEvent(LONG_VALUES.get(i % LONG_VALUES.size()), LONG_VALUES.get(i % LONG_VALUES.size()), INT_VALUES.get(i % INT_VALUES.size()), INT_VALUES.get(i % INT_VALUES.size()));
