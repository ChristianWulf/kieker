...
import kicker.common.record.jvm.UptimeRecord;
...
public class TestGeneratedUptimeRecord extends AbstractGeneratedKiekerTest {
	...
	/**
	 * Tests {@link UptimeRecord#TestUptimeRecord(long, string, string, long)}.
	 */
	@Test
	...
	public void testEquality() {
		int i = 0;
		UptimeRecord oneRecord = new UptimeRecord(LONG_VALUES.get(i % LONG_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), LONG_VALUES.get(i % LONG_VALUES.size()));
		i = 0;
		UptimeRecord copiedRecord = new UptimeRecord(LONG_VALUES.get(i % LONG_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), LONG_VALUES.get(i % LONG_VALUES.size()));
	...
	public void testUnequality() {
		...
		UptimeRecord oneRecord = new UptimeRecord(LONG_VALUES.get(i % LONG_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), LONG_VALUES.get(i % LONG_VALUES.size()));
		i = 2;
		UptimeRecord anotherRecord = new UptimeRecord(LONG_VALUES.get(i % LONG_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), LONG_VALUES.get(i % LONG_VALUES.size()));
