 ...
 ***************************************************************************/
package kicker.test.common.junit.record.jvm;
 ...
 * @since 1.10
 */
public class TestGeneratedClassLoadingRecord extends AbstractGeneratedKiekerTest {

	public TestGeneratedClassLoadingRecord() {
	...
	public void testEquality() {
		int i = 0;
		ClassLoadingRecord oneRecord = new ClassLoadingRecord(LONG_VALUES.get(i % LONG_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), LONG_VALUES.get(i % LONG_VALUES.size()), INT_VALUES.get(i % INT_VALUES.size()), LONG_VALUES.get(i % LONG_VALUES.size()));
		i = 0;
		ClassLoadingRecord copiedRecord = new ClassLoadingRecord(LONG_VALUES.get(i % LONG_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), LONG_VALUES.get(i % LONG_VALUES.size()), INT_VALUES.get(i % INT_VALUES.size()), LONG_VALUES.get(i % LONG_VALUES.size()));
	...
	public void testUnequality() {
		...
		ClassLoadingRecord oneRecord = new ClassLoadingRecord(LONG_VALUES.get(i % LONG_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), LONG_VALUES.get(i % LONG_VALUES.size()), INT_VALUES.get(i % INT_VALUES.size()), LONG_VALUES.get(i % LONG_VALUES.size()));
		i = 2;
		ClassLoadingRecord anotherRecord = new ClassLoadingRecord(LONG_VALUES.get(i % LONG_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), LONG_VALUES.get(i % LONG_VALUES.size()), INT_VALUES.get(i % INT_VALUES.size()), LONG_VALUES.get(i % LONG_VALUES.size()));
