 ...
 ***************************************************************************/
package kicker.test.common.junit.record.misc;
...
import kicker.common.record.misc.KiekerMetadataRecord;
...
public class TestGeneratedKiekerMetadataRecord extends AbstractGeneratedKiekerTest {
	...
	/**
	 * Tests {@link KiekerMetadataRecord#TestKiekerMetadataRecord(string, string, string, int, boolean, long, string, long)}.
	 */
	@Test
	public void testToArray() { // NOPMD (assert missing)
		for (int i=0;i<ARRAY_LENGTH;i++) {
			...
			// check values
			Assert.assertEquals("KiekerMetadataRecord.version values are not equal.", STRING_VALUES.get(i % STRING_VALUES.size()) == null?kicker.common.util.Version.getVERSION():STRING_VALUES.get(i % STRING_VALUES.size()), record.getVersion());
			...
			Assert.assertEquals("KiekerMetadataRecord.debugMode values are not equal.", BOOLEAN_VALUES.get(i % BOOLEAN_VALUES.size()), Boolean.valueOf(record.isDebugMode()));
			...
			Assert.assertEquals("Array value [0] " + values[0] + " does not match the desired value " + STRING_VALUES.get(i % STRING_VALUES.size()),
				STRING_VALUES.get(i % STRING_VALUES.size()) == null?kicker.common.util.Version.getVERSION():STRING_VALUES.get(i % STRING_VALUES.size()), values[0]
			);
	...
	public void testEquality() {
		int i = 0;
		KiekerMetadataRecord oneRecord = new KiekerMetadataRecord(STRING_VALUES.get(i % STRING_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), INT_VALUES.get(i % INT_VALUES.size()), BOOLEAN_VALUES.get(i % BOOLEAN_VALUES.size()), LONG_VALUES.get(i % LONG_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), LONG_VALUES.get(i % LONG_VALUES.size()));
		i = 0;
		KiekerMetadataRecord copiedRecord = new KiekerMetadataRecord(STRING_VALUES.get(i % STRING_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), INT_VALUES.get(i % INT_VALUES.size()), BOOLEAN_VALUES.get(i % BOOLEAN_VALUES.size()), LONG_VALUES.get(i % LONG_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), LONG_VALUES.get(i % LONG_VALUES.size()));
	...
	public void testUnequality() {
		...
		KiekerMetadataRecord oneRecord = new KiekerMetadataRecord(STRING_VALUES.get(i % STRING_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), INT_VALUES.get(i % INT_VALUES.size()), BOOLEAN_VALUES.get(i % BOOLEAN_VALUES.size()), LONG_VALUES.get(i % LONG_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), LONG_VALUES.get(i % LONG_VALUES.size()));
		i = 2;
		KiekerMetadataRecord anotherRecord = new KiekerMetadataRecord(STRING_VALUES.get(i % STRING_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), INT_VALUES.get(i % INT_VALUES.size()), BOOLEAN_VALUES.get(i % BOOLEAN_VALUES.size()), LONG_VALUES.get(i % LONG_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), LONG_VALUES.get(i % LONG_VALUES.size()));
